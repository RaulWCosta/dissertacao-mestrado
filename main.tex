...
\begin{document}
	\ppgccufmg{
		...
		orientador={Prof. Dr. Phablo Fernando Soares Moura}, %% Para masculino
...
%		coorientador={Ciclano}, %% Para masculino
		...
		keywords={approximation algorithms; graph theory; bounded genus; Steiner Multicycle; computational experiments.}, %% Palavras-chave do abstract
		dedicatoria={dedicatoria.tex}, %% Arquivo .tex contendo a dedicatória
		agradecimentos={agradecimentos.tex},
		epigrafe={We live only to discover beauty. All else is a form of waiting.},
		epigrafeautor={Khalil Gibran},
