...
%		coorientador={Ciclano}, %% Para masculino
		...
		palavraschave={Algoritmos de Aproximação, Teoria de Grafos, Otimização, e Complexidade Computacional}, %% Palavras-chave do resumo
		keywords={Approximation Algorithms, Graph Theory, Optimization, and Computational Complexity}, %% Palavras-chave do abstract
