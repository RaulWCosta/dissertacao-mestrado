...
\ppgccufmg{
%   title={Esquema de Aproximação em Tempo Polinomial para Multiciclos de Steiner em Grafos com Genus Limitado},
  title={Estudo algorítmico do problema de multiciclos de Steiner},
...
%   abstract={Resumo}{capitulos/resumo},
%   abstract=[english]{Abstract}{capitulos/abstract},
...
\include{capitulos/pc_partition}
\include{capitulos/ptas_bounded_tree_width}
